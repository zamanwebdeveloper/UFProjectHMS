...
class TicketBillInvoiceController extends Controller
{
    public function billShow($id,$order){
        ...
        if($id==0)
        {
            return Redirect::route('ticket_refund_bill_create',['order' => $order]);
        }else {
    ...
    public function billCreate($order=null){
        ...
        return view('settings::ticket.refund.bill_create', compact('customers','bill_number','order'));
    }
       ...
       // dd($request->all());
        ...
        if($bill->save()) {
            ...
            if($request->ticket_id){
                $order= TicketRefund::find($request->ticket_id);
    ...
    public function invoiceShow($id,$order){
        ...
        if($id==0)
        {
            return Redirect::route('ticket_refund_invoice_create',['order' => $order]);
        }
        else
        {
    ...
    public function invoiceCreate($order=null){
        ...
        return view('settings::ticket.refund.invoice_create', compact('customers','invoice_number','order'));
    }
    ...
    public function invoiceStore(Request $request){
        ...
        try
        {
            ...
            if($invoice->save())
            {
                ...
                {
                    $order= TicketRefund::find($request->invoice_id);
