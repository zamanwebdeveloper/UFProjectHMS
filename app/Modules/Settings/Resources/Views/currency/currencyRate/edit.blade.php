                    ...
                    <div class="md-card">
                        <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Edit Currency rate</span></h2>
                            </div>
                        </div>
                        <div class="user_content">
                            <div class="uk-margin-top">
                                {!! Form::open(['url' => route('settings_Currency_rate_update',$curr_rate->id), 'method' => 'POST']) !!}
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input disabled="" class="md-input" type="text" id="name" value="{{ $curr_rate['currency']["name"] }}" required/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" oninput="numbervalidate(this)" id="rate" name="rate" value="{{ $curr_rate['conversion_rate'] }}" required/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <textarea class="md-input" name="note" id="note" cols="30" rows="4">{{ $curr_rate['note'] }}</textarea>
