                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                    ...
                                    @foreach($order as $value)
                                        <tr>
                                            ...
                                            <td  data-uk-tooltip title="{{ $value->ticket_number }}">{{ $value->ticket_number }}</td>
                                            ...
                                            <td class="uk-text-right" style="white-space:nowrap !important;">
                                                ...
                                                <a title="pdf" href="{{ route('ticket_Order_pdf',['id' => $value->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="pdf"  class="material-icons">&#xE415;</i></a>
                                                <a href="{{ route('ticket_Order_bill_show',['id' => $value->bill_id?$value->bill_id:0,'order'=>$value->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="bill" class="material-icons" style="color: {{$value->bill_id?'#109300': ''}}; font-weight: bold; font-size: 30px;">B</i></a>
                                                <a href="{{ route('ticket_Order_invoice_show',['id' => $value->invoice_id?$value->invoice_id:0,'order'=>$value->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="invoice" class="material-icons" style="color: {{$value->invoice_id?'#109300': ''}}; font-weight: bold; font-size: 30px;">I</i></a>
                                                <a href="{{ route('ticket_Order_edit',['id' => $value->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="material-icons">&#xE254;</i></a>
                                                ...
                                                <a href="{!! route('ticket_Order_sendMail',$value->id) !!}"><i data-uk-tooltip="{pos:'top'}" title="mail"  class="material-icons">&#xE0BE;</i></a>
