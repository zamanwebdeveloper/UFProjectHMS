...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->call(PmsSectorsTableSeeder::class);
        $this->call(PmsAccountType::class);
        $this->call(PmsAccountSubType::class);
        $this->call(PmsAccount::class);
        $this->call(pms_contact_category::class);
        $this->call(ExpenseSectorSeeder::class);
    }
}
