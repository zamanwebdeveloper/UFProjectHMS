            ...
            $http
                ...
                .then(function(response){
                    ...
                    for(var i = 0; i < response.data.bills.length; i++)
                    {
                        ...
                        if($scope.payment_made_entry[j] != null)
                        {
                            
                            if((response.data.bills[i].id == $scope.payment_made_entry[j].bill_id) || response.data.bills[i].due_amount > 0)
                            {
                                ...
                                element.due_amount      = parseFloat(response.data.bills[i].due_amount) + parseFloat(element.payment);
                        ...
                        }else
                        {
                            ...
                            if(response.data.bills[i].due_amount > 0)
                            {
                                element.id              = response.data.bills[i].id;
                                element.bill_date       = response.data.bills[i].bill_date;
                                element.bill_number     = response.data.bills[i].bill_number;
                                ...
                                element.due_amount      = parseFloat(response.data.bills[i].due_amount);
